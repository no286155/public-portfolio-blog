...
__webpack_require__.d(__webpack_exports__, {
  a: () => (/* binding */ stegaEncodeSourceMap$1),
  e: () => (/* binding */ encodeIntoResult),
  s: () => (/* binding */ stegaEncodeSourceMap)
});

;// CONCATENATED MODULE: ./node_modules/@sanity/client/dist/_chunks-es/browserMiddleware.js
...
const VALID_ASSET_TYPES = (/* unused pure expression or super */ null && (["image", "file"])), VALID_INSERT_LOCATIONS = (/* unused pure expression or super */ null && (["before", "after", "replace"])), dataset = (name) => {
...
var _client$5;
const _ObservablePatch = class _ObservablePatch2 extends (/* unused pure expression or super */ null && (BasePatch)) {
...
let ObservablePatch = (/* unused pure expression or super */ null && (_ObservablePatch));
var _client2$5;
const _Patch = class _Patch2 extends (/* unused pure expression or super */ null && (BasePatch)) {
  constructor(selection, operations, client) {
...
let Patch = (/* unused pure expression or super */ null && (_Patch));
...
var _client$4;
const _Transaction = class _Transaction2 extends (/* unused pure expression or super */ null && (BaseTransaction)) {
...
let Transaction = (/* unused pure expression or super */ null && (_Transaction));
var _client2$4;
const _ObservableTransaction = class _ObservableTransaction2 extends (/* unused pure expression or super */ null && (BaseTransaction)) {
  constructor(operations, client, transactionId) {
...
let ObservableTransaction = (/* unused pure expression or super */ null && (_ObservableTransaction));
...
const createWarningPrinter = (message) => (
  ...
  stega: { enabled: !1 }
}, LOCALHOSTS = (/* unused pure expression or super */ null && (["localhost", "127.0.0.1", "0.0.0.0"])), isLocal = (host) => LOCALHOSTS.indexOf(host) !== -1;
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 84384)).then(function(n) {
          return n.a;
        }).then(
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), MAX_URL_LENGTH = 14800, possibleOptions = (/* unused pure expression or super */ null && ([
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = !0), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource } = await __webpack_require__.e(/* import() */ 219).then(__webpack_require__.t.bind(__webpack_require__, 39219, 23)), evs = new EventSource(uri, esOptions);
...
let ObservableSanityClient = (/* unused pure expression or super */ null && (_ObservableSanityClient));
...
let SanityClient = (/* unused pure expression or super */ null && (_SanityClient));
...
var envMiddleware = (/* unused pure expression or super */ null && ([]));

//# sourceMappingURL=browserMiddleware.js.map

;// CONCATENATED MODULE: ./node_modules/@sanity/client/dist/_chunks-es/stegaEncodeSourceMap.js

const reKeySegment = /_key\s*==\s*['"](.*)['"]/;
function isKeySegment(segment) {
  return typeof segment == "string" ? reKeySegment.test(segment.trim()) : typeof segment == "object" && "_key" in segment;
}
function stegaEncodeSourceMap_toString(path) {
...
function createEditUrl(options) {
  ...
  const workspace = _workspace === "default" ? void 0 : _workspace, tool = _tool === "default" ? void 0 : _tool, id = getPublishedId(_id), stringifiedPath = Array.isArray(path) ? stegaEncodeSourceMap_toString(jsonPathToStudioPath(path)) : path, searchParams = new URLSearchParams({
    baseUrl,
    id,
    type,
...
function prettyPathForLogging(path) {
  return stegaEncodeSourceMap_toString(jsonPathToStudioPath(path));
}
